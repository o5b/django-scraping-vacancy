...
class Vacancy(core_models.Common):
    ...
    salary = models.CharField(verbose_name='Зарплата', max_length=1000, blank=True)
    address = models.CharField(verbose_name='Адрес работы', max_length=1000, blank=True)
    place = models.CharField(verbose_name='Место работы', max_length=1000, blank=True)
    requirements = models.CharField(verbose_name='Условия и требования', max_length=1000, blank=True)
    language = models.CharField(verbose_name='Знание языков', max_length=1000, blank=True)
    contact_name = models.CharField(verbose_name='Контактное имя', max_length=1000, blank=True)
    contact_phone = models.CharField(verbose_name='Контактный телефон', max_length=1000, blank=True)
    contact_email = models.CharField(verbose_name='Контактный e-mail', max_length=1000, blank=True)
